...
function extractLocalHour(utcDateString) {
    // Create a new Date object from the UTC string
    const utcDate = new Date(utcDateString);

    // Convert the date to a locale string and extract the hour
    const localHour = utcDate.toLocaleString('en-US', {
        hour: 'numeric',
        hour12: false, // Set to true for 12-hour format, or false for 24-hour format
...
export const load = function (dailyActiveUsersData) {
    ...
    var options = {
        ...
        xaxis: {
            categories: timeList,//['12am', '2am', '4am', '6am', '8am', '10am', '12pm', '2pm', '4pm', '6pm', '8pm', '10pm'],
            labels: {
                show: true,
                style: {
                    colors: "#8c9097",
